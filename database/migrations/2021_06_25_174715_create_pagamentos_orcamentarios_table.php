...
class CreatePagamentosOrcamentariosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pagamentos_orcamentarios', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('pagamentos_orcamentarios');
    }
}
